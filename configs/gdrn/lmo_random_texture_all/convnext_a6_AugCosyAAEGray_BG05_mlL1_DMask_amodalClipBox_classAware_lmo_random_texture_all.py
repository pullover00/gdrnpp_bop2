...
OUTPUT_DIR = "output/gdrn/lmo_random_texture_all/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo_random_texture_all"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("lmo_random_texture_all_train",),
    TEST=("lmo_bop_test",),
