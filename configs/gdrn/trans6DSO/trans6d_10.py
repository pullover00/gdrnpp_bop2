...
OUTPUT_DIR = "output/gdrn/trans6DSO/10"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("trans6D_pbr_10_train",), # keys, kein Pfad
    TEST=("trans6D_10_test",),
    #DET_FILES_TEST=("datasets/BOP_DATASETS/lmo_random_texture_all/test/test_bboxes/instances_predictions_bop.json",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/trans6D/scene_gt_dummy_bb.json",),
)
