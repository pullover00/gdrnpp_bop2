...
OUTPUT_DIR = "output/gdrn/lmo_random_texture/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo_random_texture"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("lmo_random_texture_train",),
    TEST=("lmo_bop_test",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/lmo_random_texture/test/test_bboxes/yolox_x_640_lmo_random_texture_test.json",),
)
