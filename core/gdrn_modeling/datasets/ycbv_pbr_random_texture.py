...
class YCBV_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get(
            "dataset_root",
            osp.join(DATASETS_ROOT, "BOP_DATASETS/ycbv_random_texture/train_pbr"),
        )
...
SPLITS_YCBV_PBR = dict(
    ycbv_random_texture_train_pbr=dict(
        name="ycbv_random_texture_train_pbr",
        objs=ref.ycbv.objects,  # selected objects
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/ycbv_random_texture/train_pbr"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/ycbv_random_texture/models"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/ycbv_random_texture/train_pbr/xyz_crop"),
