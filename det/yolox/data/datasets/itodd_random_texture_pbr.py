...
class ITODD_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/itodd_random_texture/train_pbr"))
...
SPLITS_ITODD_PBR = dict(
    itodd_random_texture_pbr_train=dict(
        name="itodd_random_texture_pbr_train",
        objs=ref.itodd.objects,  # selected objects
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/itodd_random_texture/train_pbr"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/itodd_random_texture/models"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/itodd_random_texture/train_pbr/xyz_crop"),
