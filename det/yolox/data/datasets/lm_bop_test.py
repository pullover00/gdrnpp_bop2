...
class LM_BOP_TEST_Dataset(object):
    """lm bop test splits."""
    ...
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/lm/test"))
...
SPLITS_LM = dict(
    lm_bop_test=dict(
        ...
        ann_file=osp.join(DATASETS_ROOT, "BOP_DATASETS/lm/lm_test_targets_bb8.json"),
...
def register_with_name_cfg(name, data_cfg=None):
    ...
    if name in SPLITS_LM:
        ...
        used_cfg = data_cfg
    DatasetCatalog.register(name, LM_BOP_TEST_Dataset(used_cfg))
