...
class LM_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/lmo_random_texture_all/train_pbr"))
...
SPLITS_LM_PBR = dict(
    lmo_random_texture_all_pbr_train=dict(
        name="lmo_random_texture_all_pbr_train",
        objs=LM_OCC_OBJECTS,  # selected objects
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lmo_random_texture_all/train_pbr"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lmo_random_texture_all/models"),
        xyz_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lmo_random_texture_all/train_pbr/xyz_crop"),
