...
class TRANS6D_TEST_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/trans6d/test"))
...
SPLITS_TRANS6D = dict(
    trans6D_test=dict(
        ...
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/trans6D/test"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/trans6D/models"),
        ann_file=osp.join(DATASETS_ROOT, "BOP_DATASETS/trans6D/test_targets_bop19.json"),
...
#        "test",
#    ]:
#        name = "trans6d_{}_{}".format(obj, split)
#        ann_files = [
#            osp.join(
#                DATASETS_ROOT,
#                "BOP_DATASETS/trans6d/image_set/{}_{}.txt".format(obj, split),
#            )
#        ]
#         if name not in SPLITS_TRANS6D:
#             SPLITS_TRANS6D[name] = dict(
#                 name=name,
#                 objs=[obj],  # only this obj
#                 dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/trans6D/"),
#                 models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/trans6D/models"),
...
def register_with_name_cfg(name, data_cfg=None):
    ...
    if name in SPLITS_TRANS6D:
        used_cfg = SPLITS_TRANS6D[name]
    else:
        assert data_cfg is not None, f"dataset name {name} is not registered"
        used_cfg = data_cfg
    DatasetCatalog.register(name, TRANS6D_TEST_Dataset(used_cfg))
...
def get_available_datasets():
    return list(SPLITS_TRANS6D.keys())
